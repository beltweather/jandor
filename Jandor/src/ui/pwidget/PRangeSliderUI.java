 ...
 */
class PRangeSliderUI extends BasicSliderUI {

	private static Image sliderButtonImage;
	
	public static Image getSliderImage(int w) {
		if(sliderButtonImage == null || sliderButtonImage.getWidth(null) != w) {
			sliderButtonImage = ImageUtil.scale(JUtil.getPokeballIconImage(), w);
		}
		return sliderButtonImage;
	}
	
    /** Color of selected range. */
    private Color rangeColor = ColorUtil.RANGE_BAR_COLOR;
     ...
     * @param b RangeSlider
     */
    public PRangeSliderUI(PRangeSlider b) {
        super(b);
    }
    ...
    private void paintLowerThumb(Graphics g) {
        ...
        g2d.drawImage(getSliderImage(w), 0, 0, null);
    ...
    public void scrollByBlock(int direction) {
        synchronized (slider) {
            ...
            if (upperThumbSelected) {
                int oldValue = ((PRangeSlider) slider).getUpperValue();
                ((PRangeSlider) slider).setUpperValue(oldValue + delta);
            } else {
